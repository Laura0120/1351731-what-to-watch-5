...
class Movie extends PureComponent {
  ...
  render() {
    const {movie, renderTabs, comments, moviesLikeThis, authorizationStatus, onAddReviewClick,
      onPlayClick, onFavoriteClick, onMainPageClick, onMyListButtonClick, onMovieClick} = this.props;
